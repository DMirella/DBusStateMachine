#ifndef DBUSSTATEMACHINE_SRC_CHARACTER_HUMAN_CHARACTER_CONSTANTS_H_
#define DBUSSTATEMACHINE_SRC_CHARACTER_HUMAN_CHARACTER_CONSTANTS_H_
...
#endif  // DBUSSTATEMACHINE_SRC_CHARACTER_HUMAN_CHARACTER_CONSTANTS_H_
