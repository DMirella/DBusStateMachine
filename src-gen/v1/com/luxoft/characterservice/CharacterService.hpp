...
*/
#ifndef V1_COM_LUXOFT_CHARACTERSERVICE_CHARACTER_SERVICE_HPP_
#define V1_COM_LUXOFT_CHARACTERSERVICE_CHARACTER_SERVICE_HPP_
...
const char* CharacterService::getInterface() {
    return ("com.luxoft.characterservice.CharacterService:v1_0");
}

CommonAPI::Version CharacterService::getInterfaceVersion() {
...
#endif // V1_COM_LUXOFT_CHARACTERSERVICE_CHARACTER_SERVICE_HPP_
