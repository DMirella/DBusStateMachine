...
*/
#ifndef V1_COM_LUXOFT_HUMANCHARACTERSERVICE_Human_Character_Service_DBUS_PROXY_HPP_
#define V1_COM_LUXOFT_HUMANCHARACTERSERVICE_Human_Character_Service_DBUS_PROXY_HPP_
...
class HumanCharacterServiceDBusProxy
    : virtual public HumanCharacterServiceProxyBase,
      virtual public CommonAPI::DBus::DBusProxy {
public:
    HumanCharacterServiceDBusProxy(
        const CommonAPI::DBus::DBusAddress &_address,
        const std::shared_ptr<CommonAPI::DBus::DBusProxyConnection> &_connection);

    virtual ~HumanCharacterServiceDBusProxy() { }
...
#endif // V1_COM_LUXOFT_HUMANCHARACTERSERVICE_Human_Character_Service_DBUS_PROXY_HPP_
